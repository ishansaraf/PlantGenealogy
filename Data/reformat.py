...
def reformat(input_filename, output_filename):
    ...
    substituition_dict = {"hybrid:girl-scout-cookie":"hybrid:gsc","hybrid:platinum-girl-scout-cookie":"hybrid:platinum-gsc"}
...
if __name__ == "__main__":
    reformat("strains_with_id.csv","strains_formatted.json")